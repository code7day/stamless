...
return [
    ...
    | usados por la clase Validator. Algunas reglas tienen varias versiones,
    | como las reglas de tamaño (size). Se pueden ajustar libremente.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute proporcionado aparece en una filtración de datos conocida. Por favor elige un :attribute diferente.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí se pueden especificar mensajes de validación personalizados para
    | atributos, usando la convención "atributo.regla" para nombrar las
    | líneas. Esto permite definir un mensaje específico para una regla
    | aplicada a un atributo determinado.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se usan para reemplazar el placeholder del
    | atributo por algo más legible, como "Dirección de correo" en vez
    | de "email". Esto ayuda a que el mensaje sea más expresivo.
    |
    */
